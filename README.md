...
Figure 1: Comparison of model performance between OmniBGF and other multimodal brain graph learning models under noise interference. This highlights the robustness of our model in handling noisy multimodal data. We will add a paragraph, "Robustness Analysis", in Section 5.2, providing a detailed discussion of these results. 



Figure 2: Accuracy changes of models using different fusion methods before and after noise interference on three datasets. "Atten." indicates attention-based fusion, and "Trans." is Transformer-based fusion. As the results show, our model with PF is more robust under noise interference compared to other fusion methods. 

<img width="515" alt="image" src="https://github.com/user-attachments/assets/90f504e2-025d-4e87-bd6d-c887031dd68f" />

Table 2: Performance of models using different fusion methods before and after noise interference on the ADNI dataset (%).

<img width="368" alt="image" src="https://github.com/user-attachments/assets/51cdc715-7dee-41cd-bfa9-b322d1e49b32" />

Table 3: Performance of models using different fusion methods before and after noise interference on the PPMI dataset (%).

<img width="365" alt="image" src="https://github.com/user-attachments/assets/f3b87ff1-5823-45b9-9fb0-e4893083d544" />

Table 4: Performance of models using different fusion methods before and after noise interference on the 4RTNI dataset (%).

<img width="359" alt="image" src="https://github.com/user-attachments/assets/426413e9-bb97-4d73-bfe2-2097b9d27317" />


Table 5: Experimental results on three datasets. We compare OmniBGF with other graph diffusion methods. Particularly, for models which require unimodal data, we train these models on both unimodal data（FBG）and multimodal data that is obtained by taking the concatenation of the structural brain graph and the functional brain graph. We understand our concern about the lack of discussion on graph diffusion-based brain graph analysis works. We have tried our best to find out relevant methods that provide reproducible code. Unfortunately, we cannot access any at this moment. But we’ll discuss these works (e.g., the two papers you suggest) in the related work section.


Figure 3: This figure visualizes the top 15 ROIs with the highest SHAP values for ADNI dataset. Notably, the label of nodes is provided by AAL atals. For ADNI, the identified regions, such as Thalamus and Fusiform, are highly associated with Alzheimer’s disease, and are consistent with findings reported in prior neuroscience studies [1–2]. 
...
Figure 4: This figure visualizes the top 15 ROIs with the highest SHAP values for PPMI dataset. For PPMI, the identified regions, such as Rectus and Olfactory, are highly associated with Parkinson’s disease, and are consistent with those reported in neuroscience studies [3-4]. 
